...
The Docker image includes [site-specific article extraction rules](https://github.com/fivefilters/ftr-site-config) and is rebuilt [rebuilt weekly](https://github.com/heussd/fivefilters-full-text-rss-docker/blob/master/.github/workflows/build-and-push.yml#L8) with the latest rules. For best results, pull the updated image regularly.
